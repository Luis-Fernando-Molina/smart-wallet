...
* To allow people with no developing knowledge to build their own desktop and mobile trustworthy financial app.

* To act as a local back-end not only for native-Fermat-APPs and wallets, but also for any other mobile app.

* To be a full-stack Framework in the development of financial applications making them reliable and not easy to hack.
...
We believe the open source community collectively has more influence than any of us individually. Therefore for us it is important to acknowledge and revere services where others invested their time and efforts in order to build.

#### Developer Network

We are asking each of you to help lead the way, since we’re already connected with you on a developer and designer level, we want to expand this relationship across a network of developers throughout the world, allowing us to share new ideas and forge new collaborations. Working together, we can build the tools and technology needed in order to become financially independent, granting access from any country to financial products and safety from awful third party spying or restriction on what we can and cannot do with our money. We believe in true financial freedom.

We want to hear from you on how we can build this network. We are by now about 30 developers working full time on Fermat and our goal is to reach 300. To learn more about how to join, just read the [how-to-participate-guide](https://github.com/bitDubai/participate-now). We hope hat every single one of you will join us.  Because Fermat and the world need you.  We need your skills, imagination and optimism.  And with this new network, we're sure we can be partners for decades to come.
...
When designing Fermat we tried answer the following questions:

* How can we remove people's perceived complexity of crypto currencies?
* How can we use the collective skills of the developer community?
* How can we recycle the entire current infrastructure already in place?
* How do we integrate legal financial institutions in a way they feel comfortable?
* How do we integrate merchants, retailers and brands of all proportions in a clever way?
* How can we allow people to create digital wallets without programming anything at all?
* How can we keep people's digital money in their hands without the need of third parties? 
* How can we make an impartial system along with the developers who contributed to it?

Each of these questions are addressed and answered within Fermat.

<br>
## What is Fermat?

Fermat is a system where we experiment on what needs to be done fo the masses to adopt crypto currencies.
...
* **Fermat is P2P.** This makes it reliable and difficult to hack.

* **Fermat is built with plugins.** This enables it to be reused and for any developer to engage.
...
* **Fermat is inclusive.** By creating their own plugins, current industry members can integrate with Fermat to offer their services and products to Fermat's already user base.
...
Fermat is currently on its first version, but we're not stopping there. We have many feature ideas on our
...
* To build the best system possible manages the finances of people.*  
...
For instructions on how to install and run the source code, see the [CONTRIBUTING.md](https://github.com/bitDubai/fermat/blob/master/CONTRIBUTING.md).

#### Need help?

Having problems compiling or running Fermat the first time, or not sure how to use Fermat?  Please
log into the [IRC DEV Channel](http://irc.lc/freenode/fermat-dev/), and we will help you fix common problems and find extra help if needed.

#### Project status:

As of November 2015 the project status is the following:

Code state: Under development for 6 months. No realeses yet. 20+ full time developers working on it provided by the project's main contributor: [bitDubai](https://www.bitDubai.com).
