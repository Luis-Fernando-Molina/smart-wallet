 ...
 */
public class IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEventHandler implements EventHandler {
    /**
    ...
    public IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEventHandler(final IncomingExtraUserEventRecorderService eventRecorderService){
    ...
    public void handleEvent(PlatformEvent platformEvent) throws TransactionServiceNotStartedException, CantSaveEventException {
        ...
        if(platformEvent instanceof IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent)
            eventRecorderService.saveEvent(platformEvent);
        else
            throw  new CantSaveEventException(CantSaveEventException.DEFAULT_MESSAGE, null, "Event: " + platformEvent.getEventType().toString(), "This should have been IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent");
