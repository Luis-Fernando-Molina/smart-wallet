...
import com.bitdubai.fermat_pip_api.layer.pip_platform_service.event_manager.events.IncomingCryptoOnCryptoNetworkWaitingTransferenceExtraUserEvent;
import com.bitdubai.fermat_pip_api.layer.pip_platform_service.event_manager.events.IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceExtraUserEvent;
 ...
 */
public class IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceExtraUserEventHandler implements EventHandler {
    /**
    ...
    public void handleEvent(PlatformEvent platformEvent) throws TransactionServiceNotStartedException, CantSaveEventException {
        ...
        if(platformEvent instanceof IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceExtraUserEvent)
            eventRecorderService.saveEvent(platformEvent);
        else
            throw  new CantSaveEventException(CantSaveEventException.DEFAULT_MESSAGE, null, "Event: " + platformEvent.getEventType().toString(), "This should have been IncomingCryptoReversedOnCryptoNetworkWaitingTransferenceExtraUserEvent");
