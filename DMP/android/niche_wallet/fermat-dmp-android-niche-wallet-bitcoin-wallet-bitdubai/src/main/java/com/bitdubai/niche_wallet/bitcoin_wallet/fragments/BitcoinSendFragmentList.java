 ...
 */
public class BitcoinSendFragmentList extends Fragment {
    ...
    public static BitcoinSendFragmentList newInstance(int position) {
        BitcoinSendFragmentList f = new BitcoinSendFragmentList();
        Bundle b = new Bundle();
